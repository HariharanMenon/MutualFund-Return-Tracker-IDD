...
│   │   └── exceptions/
│   │       ├── __init__.py
│   │       ├── calculation_error.py
│   │       ├── file_error.py
│   │       └── validation_error.py
│   ├── tests/                 # Backend tests (top-level, not under app/)
│   │   ├── __init__.py
│   │   ├── conftest.py
│   │   ├── test_file_parser.py
...
│   │   └── fixtures/
│   ├── htmlcov/               # Coverage report (auto-generated by pytest --cov)
│   └── logs/
│
├── frontend/                  # React + Vite
│   ├── index.html
│   ├── vite.config.js
│   ├── package.json
│   ├── test-output.txt        # Frontend test run output (auto-generated)
│   ├── src/
│   │   ├── main.jsx
│   │   ├── App.jsx
│   │   ├── App.css
...
│       └── services/
│
├── scripts/                   # Automation (setup, dev, test, build, clean)
│   ├── setup.sh               # Mac/Linux
│   ├── start-dev.sh
│   ├── test-all.sh
│   ├── build-frontend.sh
...
└── README.md
```
> **Note:** `docs/` folders is planned for later phase but have not been created yet.
